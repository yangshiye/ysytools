...
public class Input {
    ...
    /**
     * Reads the length and string of UTF8 characters, or null. This can read strings written by {@link com.esotericsoftware.kryo.io.Output#writeString(String)}
     * , {@link com.esotericsoftware.kryo.io.Output#writeString(CharSequence)}, and {@link com.esotericsoftware.kryo.io.Output#writeAscii(String)}.
     *
     * @return May be null.
     */
    ...
    public boolean[] readBooleans(int len) {
    ...
    public String[] readStrings(int len) {
        String[] booleans = new String[len];
        for (int i = 0; i < len; i++) {
            booleans[i] = readString();
        }
        return booleans;
    }
}
